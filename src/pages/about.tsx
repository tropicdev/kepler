                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        <div className="lg:max-w-lg">
                            <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Easy Server Management</h1>
                            <p className="mt-6 text-xl leading-8 text-gray-700">
                                Welcome to Kepler! We are a one-person team dedicated to creating the ultimate Minecraft server generator and mod updater. Welcome to Kepler! We are a one-person team dedicated to creating the ultimate Minecraft server generator and mod updater.
                            </p>
                        </div>
                    </div>
                </div>
